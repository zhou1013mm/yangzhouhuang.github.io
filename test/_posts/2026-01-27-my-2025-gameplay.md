...
header:
  teaser: "/assets/images/my-2025-gameplay/DQXIS1.webp"
  overlay_image: /assets/images/my-2025-gameplay/CC.webp
  og_image: /assets/images/my-2025-gameplay/CC.webp
categories:
  - Game
tags: 
  - Game
...
<div style="display:flex;gap:0px;align-items:center;">
  <img src="{{ '/assets/images/my-2025-gameplay/CVIp.webp' | relative_url }}" style="width:20%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/MYp.webp' | relative_url }}" style="width:20%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/SHIp.webp' | relative_url }}" style="width:20%;height:auto;">  
  <img src="{{ '/assets/images/my-2025-gameplay/MRp.avif' | relative_url }}" style="width:20%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/SDp.webp' | relative_url }}" style="width:20%;height:auto;">
</div>

<div style="display:flex;gap:0px;align-items:center;">
  <img src="{{ '/assets/images/my-2025-gameplay/CKp.webp' | relative_url }}" style="width:20%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/RDRIp.webp' | relative_url }}" style="width:20%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/DQXISp.webp' | relative_url }}" style="width:20%;height:auto;">  
  <img src="{{ '/assets/images/my-2025-gameplay/GTAIVp.webp' | relative_url }}" style="width:20%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/DSIp.avif' | relative_url }}" style="width:20%;height:auto;">
</div>

<div style="display:flex;gap:0px;align-items:center;">
  <img src="{{ '/assets/images/my-2025-gameplay/HDIp.avif' | relative_url }}" style="width:20%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/HKIp.webp' | relative_url }}" style="width:20%;height:auto;">  
  <img src="{{ '/assets/images/my-2025-gameplay/OWp.webp' | relative_url }}" style="width:20%;height:auto;">
</div>
...
<figure style="width: 100%" class="align-left">
  <img src="{{ '/assets/images/my-2025-gameplay/DQXIS.webp' | relative_url }}" >
...
<figure style="width: 100%" class="align-left">
  <img src="{{ '/assets/images/my-2025-gameplay/SHI.webp' | relative_url }}">
...
<figure style="width: 100%" class="align-left">
  <img src="{{ '/assets/images/my-2025-gameplay/DSI.webp' | relative_url }}">
...
<figure style="width: 100%" class="align-left">
  <img src="{{ '/assets/images/my-2025-gameplay/CVI.webp' | relative_url }}" >
...
<figure style="width: 100%" class="align-left">
  <img src="{{ '/assets/images/my-2025-gameplay/SD.webp' | relative_url }}" >
...
<figure style="width: 100%" class="align-left">
  <img src="{{ '/assets/images/my-2025-gameplay/OW.webp' | relative_url }}" >
  <figcaption>Outer Wilds</figcaption>
</figure> 
<figure style="width: 100%" class="align-left">
  <img src="{{ '/assets/images/my-2025-gameplay/MY.webp' | relative_url }}" >
...
<div style="display:flex;gap:0px;align-items:center;">
  <img src="{{ '/assets/images/my-2025-gameplay/BGIp.webp' | relative_url }}" style="width:25%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/PETp.webp' | relative_url }}" style="width:25%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/BMWp.webp' | relative_url }}" style="width:25%;height:auto;">
  <img src="{{ '/assets/images/my-2025-gameplay/DBHp.avif' | relative_url }}" style="width:25%;height:auto;">
</div>
